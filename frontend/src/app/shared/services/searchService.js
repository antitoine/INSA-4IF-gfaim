...
function search(Restangular, $log, $q) {
    var self = this;
    self.search = function (query, nbpages, confidence, similarity, canceler) {
        return $q(function (resolve, reject) {
            Restangular.one('/search?q='+query+'&nb='+nbpages+'&confidence='+confidence+'&similarity='+similarity)
